...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_XPTT_number = 3,                /* XPTT_number  */
  YYSYMBOL_XPTT_symbol = 4,                /* XPTT_symbol  */
  YYSYMBOL_XPTT_if = 5,                    /* XPTT_if  */
  YYSYMBOL_XPTT_then = 6,                  /* XPTT_then  */
  YYSYMBOL_XPTT_else = 7,                  /* XPTT_else  */
  YYSYMBOL_XPTT_and = 8,                   /* XPTT_and  */
  YYSYMBOL_XPTT_or = 9,                    /* XPTT_or  */
  YYSYMBOL_XPTT_not = 10,                  /* XPTT_not  */
  YYSYMBOL_XPTT_mod = 11,                  /* XPTT_mod  */
  YYSYMBOL_XPTT_eq = 12,                   /* XPTT_eq  */
  YYSYMBOL_XPTT_neq = 13,                  /* XPTT_neq  */
  YYSYMBOL_XPTT_lt = 14,                   /* XPTT_lt  */
  YYSYMBOL_XPTT_lte = 15,                  /* XPTT_lte  */
  YYSYMBOL_XPTT_gt = 16,                   /* XPTT_gt  */
  YYSYMBOL_XPTT_gte = 17,                  /* XPTT_gte  */
  YYSYMBOL_XPTT_safediv = 18,              /* XPTT_safediv  */
  YYSYMBOL_XPTT_apostrophe = 19,           /* XPTT_apostrophe  */
  YYSYMBOL_20_ = 20,                       /* '+'  */
  YYSYMBOL_21_ = 21,                       /* '-'  */
  YYSYMBOL_22_ = 22,                       /* '*'  */
  YYSYMBOL_23_ = 23,                       /* '/'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "XPTT_number",
