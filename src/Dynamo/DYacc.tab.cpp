...
{
  "\"end of file\"", "error", "\"invalid token\"", "DPTT_aux",
  "DPTT_table", "DPTT_level", "DPTT_init", "DPTT_constant", "DPTT_eoq",
  "DPTT_groupstar", "DPTT_specs", "DPTT_save", "DPTT_and", "DPTT_macro",
  "DPTT_end_of_macro", "DPTT_or", "DPTT_not", "DPTT_ge", "DPTT_le",
  "DPTT_ne", "DPTT_number", "DPTT_symbol", "DPTT_units_symbol",
  "DPTT_function", "DPTT_dt_to_one", "'-'", "'+'", "'='", "'<'", "'>'",
  "'*'", "'/'", "'^'", "','", "'('", "')'", "':'", "'['", "']'", "'!'",
  "';'", "$accept", "fulleq", "teqn", "tabledef", "eqn", "stock_eqn",
  "lhs", "var", "sublist", "symlist", "subdef", "number", "maplist",
