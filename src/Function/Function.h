...
DFSubclass(FunctionSmooth, "SMOOTH", 2, "SMTH1") DFSubclass(FunctionSmoothI, "SMOOTHI", 3, "SMTH1")
    DFSubclass(FunctionSmooth3, "SMOOTH3", 2, "SMTH3") DFSubclass(FunctionSmooth3I, "SMOOTH3I", 3, "SMTH3")
        DFSubclass(FunctionTrend, "TREND", 3, "TREND") DFSubclass(FunctionFrcst, "FORECAST", 3, "FORCST")
            DFSubclass(FunctionDelay1, "DELAY1", 2, "DELAY1") DFSubclass(FunctionDelay1I, "DELAY1I", 3, "DELAY1")
                DFSubclass(FunctionDelay3, "DELAY3", 2, "DELAY3") DFSubclass(FunctionDelay3I, "DELAY3I", 3, "DELAY3")
                    DFSubclass(FunctionDelay, "DELAY FIXED", 3, "DELAY") DFSubclass(FunctionNPV, "NPV", 4, "NPV")
...
FSubclass(FunctionModulo, "MODULO", 2, "MODULO")
    FSubclass(FunctionGetDataAtTime, "GET DATA AT TIME", 2, "GET_DATA_AT_TIME")
        FSubclass(FunctionGetDataLastTime, "GET DATA LAST TIME", 1, "GET_DATA_LAST_TIME")
            FSubclass(FunctionLookupArea, "LOOKUP AREA", 3, "LOOKUPAREA")
