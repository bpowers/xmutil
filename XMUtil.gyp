...
#            './src/Vensim/VLex.y',
            ...
            './src/utf/plan9.h',
            './src/utf/rune.c',
            './src/utf/runestrcat.c',
            './src/utf/runestrchr.c',
            './src/utf/runestrcmp.c',
            './src/utf/runestrcpy.c',
            './src/utf/runestrdup.c',
            './src/utf/runestrecpy.c',
            './src/utf/runestrlen.c',
            './src/utf/runestrncat.c',
            './src/utf/runestrncmp.c',
            './src/utf/runestrncpy.c',
            './src/utf/runestrrchr.c',
            './src/utf/runestrstr.c',
            './src/utf/runetype.c',
            './src/utf/utfdef.h',
            './src/utf/utfecpy.c',
            './src/utf/utflen.c',
